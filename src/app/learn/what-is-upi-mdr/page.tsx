...
export const metadata: Metadata = {
  ...
  description: "Learn what UPI MDR (Merchant Discount Rate) is, how it works, who pays it, and how the October 2026 rules affect merchants and consumers in India.",
  alternates: {
    canonical: "/learn/what-is-upi-mdr",
  },
};
...
const ARTICLE_FAQS = [
  {
    ...
    a: "MDR stands for Merchant Discount Rate. It is the fee charged to merchants for processing digital payments.",
  },
  {
    q: "Is UPI MDR charged to the customer?",
    a: "No. UPI MDR is a merchant-side cost. It is deducted from the merchant's settlement amount, not charged to the person making the payment.",
  },
  {
    q: "What is the UPI MDR rate in India (2026)?",
    a: "From 15 October 2026, the reported standard MDR for P2M UPI transactions above ₹2,000 is 0.4%, capped at ₹300 per transaction.",
  },
];
...
export default function WhatIsUPIMDRPage() {
  const articleSchema = generateArticleSchema({
    ...
    path: "/learn/what-is-upi-mdr",
    datePublished: "2026-09-16",
    dateModified: "2026-09-18",
  });
  const breadcrumbSchema = generateBreadcrumbSchema([
    { name: "Home", path: "/" },
    { name: "Learn", path: "/learn/what-is-upi-mdr" },
    { name: "What is UPI MDR?", path: "/learn/what-is-upi-mdr" },
  ]);
      ...
      <section style={{ padding: "48px 0" }}>
        <div className="container-narrow">
          ...
          <article style={{ fontSize: 15, lineHeight: 1.9, color: "hsl(var(--foreground))" }}>
            ...
            {/* MDR Quick Reference Table — snippet-friendly */}
            <h2 style={{ fontSize: 20, fontWeight: 700, marginTop: 32, marginBottom: 12 }}>MDR Quick Reference</h2>
            <div style={{ overflowX: "auto" }}>
              <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 14 }}>
                <thead>
                  <tr style={{ borderBottom: "2px solid hsl(var(--border))" }}>
                    <th style={{ padding: "10px 12px", textAlign: "left", fontWeight: 600 }}>Transaction</th>
                    <th style={{ padding: "10px 12px", textAlign: "left", fontWeight: 600 }}>MDR Rate</th>
                    <th style={{ padding: "10px 12px", textAlign: "left", fontWeight: 600 }}>MDR Amount</th>
                    <th style={{ padding: "10px 12px", textAlign: "left", fontWeight: 600 }}>Merchant Receives</th>
                  </tr>
                </thead>
                <tbody>
                  {[
                    { amount: "₹1,000", rate: "0%", mdr: "₹0", net: "₹1,000" },
                    { amount: "₹2,000", rate: "0%", mdr: "₹0", net: "₹2,000" },
                    { amount: "₹5,000", rate: "0.4%", mdr: "₹20", net: "₹4,980" },
                    { amount: "₹10,000", rate: "0.4%", mdr: "₹40", net: "₹9,960" },
                    { amount: "₹50,000", rate: "0.4%", mdr: "₹200", net: "₹49,800" },
                    { amount: "₹75,000", rate: "0.4%", mdr: "₹300", net: "₹74,700" },
                    { amount: "₹1,00,000", rate: "0.4%", mdr: "₹300 (cap)", net: "₹99,700" },
                  ].map((row) => (
                    <tr key={row.amount} style={{ borderBottom: "1px solid hsl(var(--border))" }}>
                      <td style={{ padding: "10px 12px", fontFamily: "'JetBrains Mono', monospace" }}>{row.amount}</td>
                      <td style={{ padding: "10px 12px" }}>{row.rate}</td>
                      <td style={{ padding: "10px 12px", fontFamily: "'JetBrains Mono', monospace" }}>{row.mdr}</td>
                      <td style={{ padding: "10px 12px", fontFamily: "'JetBrains Mono', monospace" }}>{row.net}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            ...
            {/* Inline FAQ */}
            <h2 style={{ fontSize: 20, fontWeight: 700, marginTop: 32, marginBottom: 12 }}>Common Questions</h2>
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              {ARTICLE_FAQS.map((faq) => (
                ...
                >
                  ...
                  <div style={{ padding: "0 16px 14px", fontSize: 14, color: "hsl(var(--muted))", lineHeight: 1.7 }}>
                    {faq.a}
                  </div>
                </details>
              ))}
          ...
          <div style={{ marginTop: 32 }}>
            <Link href="/calculator" className="gradient-primary" style={{
              ...
              borderRadius: "var(--radius-sm)", color: "hsl(var(--primary-foreground))", textDecoration: "none", fontWeight: 600,
            }}>
