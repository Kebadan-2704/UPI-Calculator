...
export const metadata: Metadata = {
  ...
  description: "Learn about UPI Cost Calculator, our mission to make UPI payment rules transparent, and how our source-backed calculator works.",
};
      ...
      <div className="container-narrow">
        ...
        <article style={{ fontSize: 15, lineHeight: 1.9, color: "hsl(var(--foreground))" }}>
          ...
          <p>
            ...
            We use a versioned rules engine with decimal-safe arithmetic to ensure accuracy. Our
